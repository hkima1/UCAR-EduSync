...
const routes = [
  ...
  { path: '/director/approvals', eyebrow: 'Directeur', title: "File d'approbation", features: ['Validation congés', 'Bons de commande', 'Dérogations'] },
  { path: '/director/staff', eyebrow: 'Directeur', title: 'Gestion du Personnel', features: ['Corps enseignant', 'Personnels administratifs'] },
  { path: '/director/academic', eyebrow: 'Directeur', title: 'Suivi Académique', features: ['Programmes', 'Évaluation continue', 'Taux de réussite'] },
  ...
  { path: '/superadmin/institutions', eyebrow: 'Super Admin', title: 'Réseau Établissements', features: ['Carte universitaire', "Création d'établissement"] },
  { path: '/superadmin/employment-equity', eyebrow: 'Super Admin', title: "Équité d'emploi", features: ['Parité', 'Statistiques nationales', 'Diversité'] },
  ...
  { path: '/superadmin/predictions', eyebrow: 'Super Admin', title: 'Modèles Prédictifs', features: ['IA flux étudiants', 'Besoins en recrutement', "Risque d'abandon"] },
  ...
  { path: '/teacher/messages', eyebrow: 'Enseignant', title: 'Messages', features: ['Communication étudiants & administration'] },
